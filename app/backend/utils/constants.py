...
class Constants(Enum):
   ...
   URL_CRUD_EVALUATION_DATES = "/preguntas_evaluativas"
   URL_CRUD_EVALUATION_REGISTER = f"{URL_CRUD_EVALUATION_DATES}/registrar"
   URL_CRUD_EVALUATION_UPDATE = f"{URL_CRUD_EVALUATION_DATES}/actualizar/{URL_ID}"
