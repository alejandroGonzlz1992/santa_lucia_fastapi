...
# local router
schedule_main: object = APIRouter(prefix=cns.URL_CRUD.value, tags=[cns.CRUD.value])


# GET -> Schedule Main Page
@schedule_main.get(cns.URL_CRUD_SCHEDULES.value, response_class=HTMLResponse)
async def Getting_Crud_Schedule_Main_Endpoint(
        request: Request,
...
# GET -> Schedule Create Page
@schedule_main.get(cns.URL_CRUD_SCHEDULES_REGISTER.value, response_class=HTMLResponse)
async def Getting_Crud_Schedule_Create_Endpoint(
        request: Request
) -> object:
    """
    Handles the Crud URL endpoint of the application.
...
# GET -> Schedule Update Page
@schedule_main.get(cns.URL_CRUD_SCHEDULES_UPDATE.value, response_class=HTMLResponse)
async def Getting_Crud_Schedule_Update_Endpoint(
        request: Request,
